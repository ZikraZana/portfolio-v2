...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div className={`fixed top-0 w-full z-50 transition-all duration-300 ${
                ...
                <nav className="mx-auto max-w-7xl px-6 md:px-10 flex justify-between items-center">
                    ...
                    <div className="flex-shrink-0 relative z-50">
                        <h1 className={`text-xl md:text-2xl font-bold text-poppins tracking-tight transition-colors ${
            ...
            <div className={`fixed top-0 right-0 h-full w-[75%] max-w-[260px] bg-white z-[70] shadow-2xl transform transition-transform duration-300 ease-out md:hidden ${
